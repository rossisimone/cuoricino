...
public:
    ...
    mapPtr_Type unknownVectorialInterfaceMap()
    {
    	return M_gammaMapUnknownVectorial;
    }

    mapPtr_Type knownMap()
    {
    	return M_knownMap;
    }

    mapPtr_Type unknownMap()
    {
    	return M_unknownMap;
    }
...
private:
    ...
    mapPtr_Type         M_knownMap;
    mapPtr_Type         M_unknownMap;
...
template <typename mesh_Type>
void RBFhtpVectorial<mesh_Type>::buildUnknownVectorialInterfaceMap()
{
...
void RBFhtpVectorial<mesh_Type>::setupRBFData (vectorPtr_Type KnownField, vectorPtr_Type UnknownField)
{
    M_knownField   = KnownField;
    M_unknownField = UnknownField;
    M_knownMap     = KnownField->mapPtr();
    M_unknownMap   = UnknownField->mapPtr();
}
