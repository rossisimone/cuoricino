...
#ifndef RBFVECTORIAL_H
#define RBFVECTORIAL_H 1
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::setup ( meshPtr_Type fullMeshKnown, meshPtr_Type localMeshKnown, meshPtr_Type fullMeshUnknown, meshPtr_Type localMeshUnknown, flagContainer_Type flags )
{
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::setRadius ( double radius )
{
    M_radius = radius;
}

template <typename mesh_Type>
void RBFvectorial<mesh_Type>::setupRBFData (vectorPtr_Type KnownField, vectorPtr_Type UnknownField, GetPot datafile, parameterList_Type belosList)
{
...
void RBFvectorial<Mesh>::buildOperators()
{
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::projectionOperator()
{
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::buildRhs()
{
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::interpolate()
{
    ...
    M_projectionOperator->multiply (false, *gamma_f1, *solution1);

    vectorPtr_Type solution2;
    solution2.reset (new vector_Type (*M_projectionOperatorMap) );
    M_projectionOperator->multiply (false, *gamma_f2, *solution2);
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::identifyNodes (meshPtr_Type LocalMesh, boost::unordered_set<ID>& GID_nodes, vectorPtr_Type CheckVector)
{
    if (M_flags[0] == -1)
    {
...
template <typename mesh_Type>
void RBFvectorial<mesh_Type>::solution (vectorPtr_Type& Solution)
{
...
namespace
{
static bool S_registerTriV = RBFInterpolation<LifeV::RegionMesh<LinearTriangle > >::InterpolationFactory::instance().registerProduct ( "RBFvectorial", &createRBFvectorial<LifeV::RegionMesh<LinearTriangle > > );
static bool S_registerTetV = RBFInterpolation<LifeV::RegionMesh<LinearTetra > >::InterpolationFactory::instance().registerProduct ( "RBFvectorial", &createRBFvectorial<LifeV::RegionMesh<LinearTetra > > );
}

} // Namespace LifeV

#endif /* RBFVECTORIAL_H */
