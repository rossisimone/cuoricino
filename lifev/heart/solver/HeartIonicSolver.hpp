...
/////////////////////////////////////////////////////////////////////////
//Physiological model for the heart membrane
//Parameters and methods as in Luo-Rudy 91.
////////////////////////////////////////////////////////////////////////
...
//! Constructor
template<typename Mesh, typename SolverType>
LuoRudy<Mesh, SolverType>::LuoRudy( const data_Type& dataType,
				    const Mesh& mesh,
				    FESpace<Mesh, MapEpetra>& uFEspace,
				    Epetra_Comm& comm ):
  HeartIonicSolver<Mesh, SolverType>( dataType, mesh, uFEspace, comm),
...
template< typename Mesh,
          typename SolverType = LifeV::SolverAztecOO >
class MinimalModel : public virtual HeartIonicSolver<Mesh, SolverType>
{
public:
	typedef typename HeartIonicSolver<Mesh, SolverType>::data_Type data_Type;
	typedef typename HeartIonicSolver<Mesh, SolverType>::vector_Type vector_Type;
...
MinimalModel( const data_Type& dataType,
    ...
    M_vectorW1change ( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
    M_vectorW2change ( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
    M_vectorW3change ( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
...
template< typename Mesh,
          typename SolverType = LifeV::SolverAztecOO >
class CourtemancheRamirezNattel : public virtual HeartIonicSolver<Mesh, SolverType>
{
public:
	typedef typename HeartIonicSolver<Mesh, SolverType>::data_Type data_Type;
	typedef typename HeartIonicSolver<Mesh, SolverType>::vector_Type vector_Type;
    ...
    const vector_Type& solutionGatingJ() const {return M_solutionGatingJ;}
    const vector_Type& solutionGatingM() const {return M_solutionGatingM;}
    const vector_Type& solutionGatingAA() const {return M_solutionGatingAA;}
    const vector_Type& solutionGatingAI() const {return M_solutionGatingAI;}
    const vector_Type& solutionGatingUA() const {return M_solutionGatingUA;}
    const vector_Type& solutionGatingUI() const {return M_solutionGatingUI;}
    const vector_Type& solutionGatingXR() const {return M_solutionGatingXR;}
    const vector_Type& solutionGatingXS() const {return M_solutionGatingXS;}
    const vector_Type& solutionGatingD() const {return M_solutionGatingD;}
    const vector_Type& solutionGatingF() const {return M_solutionGatingF;}
    const vector_Type& solutionGatingFCa() const {return M_solutionGatingFCa;}
    const vector_Type& solutionGatingPU() const {return M_solutionGatingPU;}
    const vector_Type& solutionGatingPV() const {return M_solutionGatingPV;}
    const vector_Type& solutionGatingPW() const {return M_solutionGatingPW;}
    const vector_Type& vectorConcentrationNa() const {return M_vectorConcentrationNa;}
    const vector_Type& vectorConcentrationK() const {return M_vectorConcentrationK;}
    const vector_Type& vectorConcentrationCa() const {return M_vectorConcentrationCa;}
...
CourtemancheRamirezNattel( const data_Type& dataType,
		...
		Epetra_Comm& comm ):
			...
			M_vectorExponentialj(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialm(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialaa(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialai(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialua(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialui(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialxr(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialxs(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentiald(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialf(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialfca(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialpu(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialpv(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorExponentialpw(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumh(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumj(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumm(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumaa(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumai(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumua(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumui(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumxr(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumxs(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumd(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumf(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumfca(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumpu(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumpv(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorInfimumpw(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorFn(HeartIonicSolver<Mesh,SolverType>::M_localMap),
			M_vectorIonicChange(HeartIonicSolver<Mesh, SolverType>::M_localMap),
			M_solutionGatingH( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingJ( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingM( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingAA( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingAI( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingUA( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingUI( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingXR( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingXS( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingD( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
		    	M_solutionGatingF( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingFCa( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingPU( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingPV( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_solutionGatingPW( HeartIonicSolver<Mesh, SolverType>::M_localMap ),

			// Concentration
			M_vectorConcentrationNa( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorConcentrationK( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
		    	M_vectorConcentrationCa( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorConcentrationCaRel( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorConcentrationCaUp( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorIonicChangeCa( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorIonicChangeNa( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorIonicChangeK( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorIonicChangeCaUp( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_vectorIonicChangeCaRel( HeartIonicSolver<Mesh, SolverType>::M_localMap ),

			//Currents
			M_vectorCurrentIrel( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_ionicCurrent( HeartIonicSolver<Mesh, SolverType>::M_localMap ),
			M_ionicCurrentRepeated( M_ionicCurrent, Repeated ),
			M_elemVecIonicCurrent ( HeartIonicSolver<Mesh, SolverType>::M_uFESpace.fe().nbFEDof(), 1 )
{
