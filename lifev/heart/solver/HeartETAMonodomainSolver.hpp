...
//    typedef boost::shared_ptr<exporter_Type>                       exporterPtr_Type;
	...
	HeartETAMonodomainSolver(list_Type list, GetPot& dataFile,
	 ...
	 */
	HeartETAMonodomainSolver(GetPot& dataFile, ionicModelPtr_Type model,
	...
	HeartETAMonodomainSolver(std::string meshName, std::string meshPath,
	 ...
	 * @param HeartETAmonodomainSolver object
	 */
	HeartETAMonodomainSolver<Mesh, IonicModel>& operator=(
			const HeartETAMonodomainSolver& solver);
	...
	inline void setPotential(const vector_Type& p) {
		(*(M_potentialPtr)) = p;
	}
	...
	void inline partitionMesh(std::string meshName, std::string meshPath) {
		MeshUtility::fillWithFullMesh(M_localMeshPtr, M_fullMeshPtr, meshName,
				meshPath);
	}
	...
	inline void setupFibers(std::string fibersFile, std::string directory,
			int format = 0) {
		HeartUtility::importFibersFromTextFile(M_fiberPtr, fibersFile, directory, format);
	}
...
// ===================================================
template<typename Mesh, typename IonicModel>
HeartETAMonodomainSolver<Mesh, IonicModel>::HeartETAMonodomainSolver() {
	setParameters();
	init();
}
...
template<typename Mesh, typename IonicModel>
HeartETAMonodomainSolver<Mesh, IonicModel>& HeartETAMonodomainSolver<Mesh,
		IonicModel>::operator=(const HeartETAMonodomainSolver& solver) {
...
/********* SETUP METHODS */ //////
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupFibers() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::exportFiberDirection() {
	boost::shared_ptr<FESpace<mesh_Type, MapEpetra> > Space3D(
			new FESpace<mesh_Type, MapEpetra>(M_localMeshPtr, M_elementsOrder,
					3, M_commPtr));
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setup(GetPot& dataFile,
		short int ionicSize) {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setup(std::string meshName,
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupMassMatrix() {
	{
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupLumpedMassMatrix() {
	{
		using namespace ExpressionAssembly;
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupStiffnessMatrix()
{
	if(M_displacementPtr) setupStiffnessMatrix( M_displacementPtr );
	else 				  setupStiffnessMatrix( M_diffusionTensor );
}
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupStiffnessMatrix( vectorPtr_Type disp )
{
	{
//		boost::shared_ptr<FESpace<mesh_Type, MapEpetra> > Space3D(
//				new FESpace<mesh_Type, MapEpetra>(M_localMeshPtr, M_elementsOrder,
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupGlobalMatrix() {
	(*M_globalMatrixPtr) *= 0;
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupLinearSolver(
		GetPot dataFile) {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupGlobalSolution(
		short int ionicSize) {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupGlobalRhs(
		short int ionicSize) {
...
/************** EXPORTER */    //////////////
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupPotentialExporter(
		exporter_Type& exporter) {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setupExporter(
		exporter_Type& exporter) {
	exporter.setMeshProcId(M_localMeshPtr, M_commPtr->MyPID());
...
/********* SOLVING METHODS */    ////////////////////////
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneReactionStepFE() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneReactionStepROS3P(
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneDiffusionStepBE() {
	M_linearSolverPtr->setRightHandSide(M_rhsPtrUnique);
	M_linearSolverPtr->solve(M_potentialPtr);
}

template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneSplittingStep() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveSplitting() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneStepGatingVariablesFE() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::computeRhsICI() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::computeRhsSVI() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneICIStep() {
	computeRhsICI();
	M_linearSolverPtr->setRightHandSide(M_rhsPtrUnique);
	M_linearSolverPtr->solve(M_potentialPtr);
}
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveOneSVIStep() {
	computeRhsSVI();
	M_linearSolverPtr->setRightHandSide(M_rhsPtrUnique);
	M_linearSolverPtr->solve(M_potentialPtr);
}
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveICI() {
	for (Real t = M_initialTime; t < M_endTime;) {
		t = t + M_timeStep;
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::solveSVI() {
	for (Real t = M_initialTime; t < M_endTime;) {
		t = t + M_timeStep;
		solveOneStepGatingVariablesFE();
		solveOneSVIStep();
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::init() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::init(commPtr_Type comm) {
	init();
	M_commPtr = comm;
	M_localMeshPtr.reset(new mesh_Type(M_commPtr));
	M_fullMeshPtr.reset(new mesh_Type(M_commPtr));
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::init(meshPtr_Type meshPtr) {
	init();
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setParameters() {
...
template<typename Mesh, typename IonicModel>
void HeartETAMonodomainSolver<Mesh, IonicModel>::setParameters(list_Type list) {
