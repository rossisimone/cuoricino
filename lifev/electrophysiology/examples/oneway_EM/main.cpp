...
#include <lifev/electrophysiology/solver/ElectroUpdatedMonodomainSolver.hpp>
...
#include <lifev/electrophysiology/solver/ElectroAlievPanfilov.hpp>
...
public:
    ...
    void computeDispl (ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::vector_Type& dep,
                       ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >& electricModel,
                       ElectroMonodomainData& dataMonodomain);

    //! To compute the righthand side of the electrical system
    void computeRhs ( ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::vector_Type& rhs,
                      ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >& electricModel,
...
ElectroMech::run()
{
    typedef ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::vector_Type  vector_Type;
    typedef ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::matrix_Type  matrix_Type;
    ...
    ElectroMonodomainData _dataFunctors (M_heart_fct);
    ElectroIonicData _dataIonic (M_heart_fct->M_dataFile);
    ...
    ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> > electricModel (_dataFunctors, *uFESpacePtr, BChE, M_heart_fct->M_comm);
    if (verbose)
    {
...
void ElectroMech::computeDispl (ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::vector_Type& displElech, ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >& electricModel, ElectroMonodomainData& data)
{
    bool verbose = (M_heart_fct->M_comm->MyPID() == 0);
    typedef ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::vector_Type  vector_Type;
    if (verbose)
...
void ElectroMech::computeRhs ( ElectroUpdatedMonodomainSolver< RegionMesh<LinearTetra> >::vector_Type& rhs,
                               ElectroUpdatedMonodomainSolver<  RegionMesh<LinearTetra> >& electricModel,
                               boost::shared_ptr< ElectroIonicSolver<  RegionMesh<LinearTetra> > > ionicModel,
                               ElectroMonodomainData& data)
