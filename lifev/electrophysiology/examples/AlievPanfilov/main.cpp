...
Int main ( Int argc, char** argv )
{
    ...
    ElectroIonicData dataIonic (M_heart_fct->M_dataFile);
    ...
    boost::shared_ptr< ElectroAlievPanfilov < mesh_Type > > ionicModel;

    if (verbose)
    {
        std::cout << "Ion Model = Aliev-Panfilov" << std::endl << std::flush;
    }
    ionicModel.reset (new ElectroAlievPanfilov< mesh_Type > (dataIonic,
