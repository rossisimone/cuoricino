...
/*!
  @file
  @brief Solver for the monodomain equations including semilinear diffusion and deforming domain
...
#ifndef _UPDATEDMONODOMAINSOLVER_H_
#define _UPDATEDMONODOMAINSOLVER_H_
...
#include <lifev/electrophysiology/solver/ElectroMonodomainData.hpp>
#include <lifev/core/util/LifeChrono.hpp>
#include <boost/shared_ptr.hpp>
#include <lifev/core/fem/FESpace.hpp>
#include <lifev/electrophysiology/solver/ElectroStiffnessFibers.hpp>
...
class ElectroUpdatedMonodomainSolver
{
...
public:
    ...
    typedef ElectroMonodomainData data_type;
...
ElectroUpdatedMonodomainSolver ( const data_type&          dataType,
    ...
    M_disp                   ( M_localMapVector, Repeated ),
...
template<typename Mesh, typename SolverType>
void ElectroUpdatedMonodomainSolver<Mesh, SolverType>::setup ( const GetPot& dataFile )
{
...
template<typename Mesh, typename SolverType>
void ElectroUpdatedMonodomainSolver<Mesh, SolverType>::buildSystem()
{
...
template<typename Mesh, typename SolverType>
void ElectroUpdatedMonodomainSolver<Mesh, SolverType>::
...
template<typename Mesh, typename SolverType>
void ElectroUpdatedMonodomainSolver<Mesh, SolverType>::PDEiterate ( bcHandlerRaw_Type& bch )
{
...
template<typename Mesh, typename SolverType>
void ElectroUpdatedMonodomainSolver<Mesh, SolverType>::moveMesh (vector_Type const& dep)
{
...
#endif //_UPDATEDMONODOMAINSOLVER_H_
