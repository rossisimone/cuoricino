...
public:
    ...
    ElectroMonodomainSolver ( const data_type& dataType,
                              FESpace<Mesh, MapEpetra>& uFESpace,
                              BCHandler& bcHandler,
                              boost::shared_ptr<Epetra_Comm>& comm);

    //! Destructor
    virtual ~ElectroMonodomainSolver() {}
...
ElectroMonodomainSolver<Mesh, SolverType>::
ElectroMonodomainSolver ( const data_type&          dataType,
                          FESpace<Mesh, MapEpetra>& uFESpace,
                          BCHandler&                BCh_u,
                          boost::shared_ptr<Epetra_Comm>&              comm ) :
...
template<typename Mesh, typename SolverType>
void ElectroMonodomainSolver<Mesh, SolverType>::setup ( const GetPot& dataFile )
{
...
template<typename Mesh, typename SolverType>
void ElectroMonodomainSolver<Mesh, SolverType>::buildSystem()
{
...
template<typename Mesh, typename SolverType>
void ElectroMonodomainSolver<Mesh, SolverType>::
...
template<typename Mesh, typename SolverType>
void ElectroMonodomainSolver<Mesh, SolverType>::PDEiterate ( bcHandlerRaw_Type& bch )
{
...
template<typename Mesh, typename SolverType>
void ElectroMonodomainSolver<Mesh, SolverType>::solveSystem ( matrixPtr_Type  matrFull,
                                                              vector_Type&    rhsFull )
{
    LifeChrono chrono;
...
template<typename Mesh, typename SolverType>
void ElectroMonodomainSolver<Mesh, SolverType>::applyBoundaryConditions ( matrix_Type&        matrix,
                                                                          vector_Type&        rhs,
