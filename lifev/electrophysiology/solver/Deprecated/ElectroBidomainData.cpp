...
// ===================================================
ElectroBidomainData::ElectroBidomainData ( boost::shared_ptr<ElectroFunctors> heart ) :
...
ElectroBidomainData::ElectroBidomainData() :
    MeshData                            ( ),
    TimeData                            ( ),
    M_fibersFormat                      ( ),
    M_hasFibers                         ( ),
...
ElectroBidomainData::ElectroBidomainData ( const ElectroBidomainData& dataBidomain ) :
...
// ===================================================
ElectroBidomainData&
ElectroBidomainData::operator= ( const ElectroBidomainData& dataBidomain )
{
...
void
ElectroBidomainData::setup (  const GetPot& dataFile )
{
...
void
ElectroBidomainData::showMe ( std::ostream& output )
{
