...
// ===================================================
ElectroMonodomainData::ElectroMonodomainData (   boost::shared_ptr<ElectroFunctors> heart ) :
...
ElectroMonodomainData::ElectroMonodomainData() :
    MeshData                        ( ),
    TimeData                        ( ),
    M_hasFibers                     ( ),
    M_verbose                       ( ),
...
ElectroMonodomainData::ElectroMonodomainData ( const ElectroMonodomainData& dataMonodomain ) :
...
// Methods
// ===================================================
ElectroMonodomainData&
ElectroMonodomainData::operator= ( const ElectroMonodomainData& dataMonodomain )
{
...
void
ElectroMonodomainData::setup (  const GetPot& dataFile )
{
...
void
ElectroMonodomainData::showMe ( std::ostream& output )
{
