...
public:
    ...
    ElectroMonodomainData ( boost::shared_ptr<ElectroFunctors> heart);

    ElectroMonodomainData ( const ElectroMonodomainData& dataMonodomain );

    virtual           ~ElectroMonodomainData() {}
    //@}
