...
#include <lifev/electrophysiology/solver/ElectroBidomainData.hpp>
...
public:
    ...
    typedef ElectroBidomainData data_type;
...
template<typename Mesh, typename SolverType>
ElectroBidomainSolver<Mesh, SolverType>::
~ElectroBidomainSolver()
{
}

template<typename Mesh, typename SolverType>
void ElectroBidomainSolver<Mesh, SolverType>::setup ( const GetPot& dataFile )
{
...
template<typename Mesh, typename SolverType>
void ElectroBidomainSolver<Mesh, SolverType>::buildSystem()
{
...
template<typename Mesh, typename SolverType>
void ElectroBidomainSolver<Mesh, SolverType>::
...
template<typename Mesh, typename SolverType>
void ElectroBidomainSolver<Mesh, SolverType>::PDEiterate ( bchandlerRaw_Type& bch )
{
...
template<typename Mesh, typename SolverType>
Real ElectroBidomainSolver<Mesh, SolverType>::computeMean ( vector_Type& x )
{
...
template<typename Mesh, typename SolverType>
void ElectroBidomainSolver<Mesh, SolverType>::removeValue ( vector_Type& x, Real& value )
{
