...
public:
    ...
    */
    ...
    ElectroBidomainData ( boost::shared_ptr<ElectroFunctors> heart);

    ElectroBidomainData ( const ElectroBidomainData& dataBidomain );

    virtual ~ElectroBidomainData() {}
    //@}
