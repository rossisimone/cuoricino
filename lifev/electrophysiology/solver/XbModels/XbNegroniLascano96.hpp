...
class XbNegroniLascano96 : public virtual ElectroXbModel
{
...
public:
    ...
    void computeRhs ( const std::vector<Real>& v, const Real& Ca, const Real& vel,  std::vector<Real>& rhs, Real FLR = 1000.);
