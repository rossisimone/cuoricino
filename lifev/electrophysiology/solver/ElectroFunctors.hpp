...
#ifndef _ELECTROFUNCTORS_H_
#define _ELECTROFUNCTORS_H_
...
public:
    ...
    ElectroFunctors ( GetPot& dataFile );

    virtual ~ElectroFunctors() {}
    //@}
...
private:
    ...
    ElectroFunctors ( const ElectroFunctors& heartFunctors );

    ElectroFunctors& operator= ( const ElectroFunctors& heartFunctors );
