...
// ===================================================
ElectroFunctors::ElectroFunctors() :
    M_dataFile          ( ),
    M_stimulusSource    ( ),
    M_stimulusPeriod1   ( ),
    M_stimulusPeriod1b   ( ),
...
ElectroFunctors::ElectroFunctors ( GetPot& dataFile ) :
    M_dataFile          (dataFile),
...
// ===================================================
Real
ElectroFunctors::setAppliedCurrent ( const Real& x, const Real& y, const Real& z, const Real& t ) const
{
...
Real
ElectroFunctors::setStimulus ( const Real& t, const Real& x, const Real& y, const Real& z, const ID&   id) const
{
    Real returnValue1;
    Real returnValue1b;
    Real returnValue2;
...
ElectroFunctors::region1_Type
ElectroFunctors::appliedCurrent()
{
    region1_Type f;
    f = boost::bind (&ElectroFunctors::setAppliedCurrent, this, _1, _2, _3, _4 );
    return f;
}

ElectroFunctors::region1_Type
ElectroFunctors::stimulus()
{
    region1_Type f;
    f = boost::bind (&ElectroFunctors::setStimulus, this, _1, _2, _3, _4, _5);
    return f;
}

const ElectroFunctors::region_Type
ElectroFunctors::reducedConductivitySphere()
{
    region_Type f;
    f = boost::bind (&ElectroFunctors::setReducedConductivitySphere, this, _1, _2, _3, _4, _5, _6);
    return f;
}

const ElectroFunctors::region_Type
ElectroFunctors::reducedConductivityCylinder()
{
    region_Type f;
    f = boost::bind (&ElectroFunctors::setReducedConductivityCylinder, this, _1, _2, _3, _4, _5, _6);
    return f;
}

const ElectroFunctors::region_Type
ElectroFunctors::reducedConductivityBox()
{
    region_Type f;
    f = boost::bind (&ElectroFunctors::setReducedConductivityBox, this, _1, _2, _3, _4, _5, _6);
    return f;
}

const ElectroFunctors::region1_Type
ElectroFunctors::initialScalar()
{
    region1_Type f;
    f = boost::bind (&ElectroFunctors::setInitialScalar, this, _1, _2, _3, _4, _5);
    return f;
}

const ElectroFunctors::region1_Type
ElectroFunctors::zeroScalar()
{
    region1_Type f;
    f = boost::bind (&ElectroFunctors::setZeroScalar, this, _1, _2, _3, _4, _5);
    return f;
}
