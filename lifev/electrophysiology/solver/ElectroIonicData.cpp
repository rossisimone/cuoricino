...
// ===================================================
//! Constructors
ElectroIonicData::ElectroIonicData ( const GetPot& dataFile ) :
...
ElectroIonicData::ElectroIonicData() :
    MeshData                        ( ),
    TimeData                        ( ),
    M_verbose                       ( ),
    M_RMCParameterA                 ( ),
...
ElectroIonicData::ElectroIonicData ( const ElectroIonicData& dataIonic ) :
    MeshData                        ( dataIonic ),
    TimeData                        ( dataIonic ),
...
// ===================================================
ElectroIonicData&
ElectroIonicData::operator= ( const ElectroIonicData& dataIonic )
{
    if ( this != &dataIonic )
    {
        M_MSHasHeterogeneousTauClose    = dataIonic.M_MSHasHeterogeneousTauClose;
...
void
ElectroIonicData::setup (  const GetPot& dataFile )
{
...
void ElectroIonicData::showMe ( std::ostream& /*output*/ )
{
}
