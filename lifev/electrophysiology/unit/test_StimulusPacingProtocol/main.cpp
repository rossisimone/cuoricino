...
//    bool verbose = false;
    ...
    CardiacStimulusPacingProtocol stimulus;
    ...
    stimulus.setPacingProtocol("FCL");
   if ( Comm->MyPID() == 0 )
    {
    ...
    stimulus.setPacingProtocol("FCL-ExtraSt");
    ...
    stimulus.setPacingProtocol("S1S2Pro");
    ...
    stimulus.setPacingProtocol("DynPro");
