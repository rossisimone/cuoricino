...
//		}
  ...
  //  M_gammaf  = dataFile ( "solid/physics/gammaf",  0. );
    ...
    //! 1. Constructor of the structuralSolver
     ...
     std::string solid_fiber_file =parameterList.get("solid_fiber_file","");
         std::cout << "\nfibers file " << solid_fiber_file << std::endl;
     // sheet direction
     std::string solid_sheet_file =parameterList.get("solid_sheet_file","");
     std::string solid_sheet_field =parameterList.get("solid_sheet_field","sheets");
         std::cout << "\nsheet file " << solid_sheet_file << std::endl;
         std::cout << "\nsheet field " << solid_sheet_field << std::endl;

     vectorPtr_Type solidFibers( new vector_Type( dFESpace -> map() ) );
     HeartUtility::importFibers ( solidFibers,
    		 	 	 	 	 	     solid_fiber_file,
     	 	 	 	 	 	 	     localSolidMesh );
     ...
     HeartUtility::importVectorField(solidSheet,
    		 	 	 	 	 	 	  solid_sheet_file,
     									solid_sheet_field,
     									localSolidMesh );
