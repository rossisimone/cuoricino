...
//    typedef boost::shared_ptr< bcInterface_Type >              bcInterfacePtr_Type;
	...
	inline 	meshPtr_Type	meshPtr() { return M_meshPtr; }
	...
	inline 	Real	activeCoefficient()	{ return M_activeCoefficient; }

	inline 		matrixPtr_Type	massMatrixPtr()	{ return M_massMatrixPtr; }
	inline 		vectorPtr_Type 	rhsPtr()	{ return M_rhsPtr; }
	inline 		vectorPtr_Type	fiberPtr()	{ return M_fiberPtr; }

	inline 		basePrecPtr_Type 	precPtr()		{ return M_precPtr; }
	inline 		linearSolver_Type& 	linearSolver()		{ return M_linearSolver; }
	inline 	    exporterPtr_Type	exporterPtr()	{ return M_exporterPtr; }


	////setters
	inline void 	setGammafPtr(vectorPtr_Type p) { M_gammafPtr = p; }
	inline void 	setGammafPtr(vector_Type& p) { *M_gammafPtr = p; }

	inline 	void	setMeshPtr( meshPtr_Type p) { M_meshPtr = p; }
	inline 	void	setMeshPtr( mesh_Type& p) { *M_meshPtr = p; }

	inline 	void setETFESpacePtr( ETFESpacePtr_Type p)	{ M_ETFESpacePtr = p; }
	inline 	void setSolidETFESpacePtr( solidETFESpacePtr_Type p)	{ M_solidETFESpacePtr = p; }
	inline 	void setFESpacePtr( FESpacePtr_Type p)		{ M_FESpacePtr = p; }
	...
	inline 	void 	setOrthotropicActivationAnisotropyRatio(Real p)	{ M_orthotropicActivationAnisotropyRatio = p; }
	inline 	void 	setActiveViscosity(Real p)	{ M_activeViscosity = p; }
