...
#ifndef EXPRESSION_ROTATE_MATRIX_HPP
#define EXPRESSION_ROTATE_MATRIX_HPP
...
//! class ExpressionRotateMatrix Class representing an interpolation in an expression.
/*!
