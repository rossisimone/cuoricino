...
/*!
 *   @file
     @brief This file contains the definition of the EvaluationRotateSmallMatrix class.

     @date 06/2011
     @author Samuel Quinodoz <samuel.quinodoz@epfl.ch>
 */

#ifndef EVALUATION_ROTATE_SMALL_MATRIX_HPP
#define EVALUATION_ROTATE_SMALL_MATRIX_HPP
...
class EvaluationRotateSmallMatrix
{
public:
...
private:
    ...
    EvaluationRotateSmallMatrix();

    //! Copy constructor
    EvaluationRotateSmallMatrix (const EvaluationRotateSmallMatrix<MeshType, MapType, SpaceDim, FieldDim>& evaluation);

    //! Expression-based constructor
    explicit EvaluationRotateSmallMatrix (const ExpressionRotateSmallMatrix<MeshType, MapType, SpaceDim, FieldDim>& expression);
...
class EvaluationRotateSmallMatrix<MeshType, MapType, 3, 1>
{
...
public:
    ...
    //! Copy constructor
    EvaluationRotateSmallMatrix (const EvaluationRotateSmallMatrix<MeshType, MapType, 3, 1>& evaluation)
        :
    ...
    //! Expression-based constructor
    explicit EvaluationRotateSmallMatrix (const ExpressionRotateSmallMatrix<MeshType, MapType, 3, 1>& expression)
        :
    ...
    void update (const UInt& iElement)
    {
        ...
        Real longitudinalComponent = M_matrix[0][0];
        Real transversalComponent  = M_matrix[1][1];
...
template<typename MeshType, typename MapType >
const flag_Type
EvaluationRotateSmallMatrix<MeshType, MapType, 3, 1>::
