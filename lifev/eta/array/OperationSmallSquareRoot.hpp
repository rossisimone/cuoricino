 ...
 *   @file
     ...
     @date 09/2013
     @author SIMONE Rossi <samuel.quinodoz@epfl.ch>
 */

#ifndef OPERATION_SMALL_SQUAREROOT_HPP
#define OPERATION_SMALL_SQUAREROOT_HPP
...
namespace LifeV
{
//! class OperationSmallSquareRoot  Class containing information about the  square root operation between the *Small classes.
...
template <>
class OperationSmallSquareRoot<Real>
{
public:
