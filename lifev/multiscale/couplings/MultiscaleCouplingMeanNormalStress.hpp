 ...
 *
 *  The MultiscaleCouplingMeanNormalStress class is an implementation of the multiscaleCoupling_Type
 *  for applying Stress coupling conditions on the models.
 */
class MultiscaleCouplingMeanNormalStress: public virtual multiscaleCoupling_Type
{
public:
    ...
    //! Constructor
    explicit MultiscaleCouplingMeanNormalStress();
...
inline multiscaleCoupling_Type* createMultiscaleCouplingMeanNormalStress()
{
    return new MultiscaleCouplingMeanNormalStress();
}

} // Namespace Multiscale
} // Namespace LifeV

#endif /* MultiscaleCouplingMeanNormalStress_H */
